...
public class CustomConfig {
	...
	public List<Job> customJobs() throws ClassNotFoundException, InstantiationException, IllegalAccessException {
		...
		reader.setId(1);
		reader.setName(com.arpitjava.springbootbatch.enums.Reader.READER.toString());
		reader.setReaderClassName("com.arpitjava.springbootbatch.step.Reader");

		Writer writer = new Writer();
		writer.setId(1);
		writer.setName(com.arpitjava.springbootbatch.enums.Writer.WRITER.toString());
		writer.setWriterClassName("com.arpitjava.springbootbatch.step.Writer");

		Processor processor = new Processor();
		processor.setId(1);
		processor.setName(com.arpitjava.springbootbatch.enums.Processor.PROCESSOR.toString());
	...
	/*	Step step2 = new Step();
		...
		reader2.setId(2);
		reader2.setName(com.arpitjava.springbootbatch.enums.Reader.READER2.toString());
		reader2.setReaderClassName("com.arpitjava.springbootbatch.step.Reader");

		Writer writer2 = new Writer();
		writer2.setId(2);
		writer2.setName(com.arpitjava.springbootbatch.enums.Writer.WRITER2.toString());
		writer2.setWriterClassName("com.arpitjava.springbootbatch.step.Writer");

		Processor processor2 = new Processor();
		processor2.setId(2);
		processor2.setName(com.arpitjava.springbootbatch.enums.Processor.PROCESSOR2.toString());
		processor2.setProcessorClassName("com.arpitjava.springbootbatch.step.Processor");
		
		step2.setReader(reader2);
		step2.setWriter(writer2);
		step2.setProcessor(processor2);*/
		
		job2.getSteps().add(step1);
	...
	public List<org.springframework.batch.core.Job> registerJobs()
		...
		for (com.arpitjava.springbootbatch.pojo.Job job : jobs) {
			...
			for (com.arpitjava.springbootbatch.pojo.Step step : steps) {
				...
				if(itemProcessor instanceof com.arpitjava.springbootbatch.step.Processor) {
					com.arpitjava.springbootbatch.step.Processor processorLoc = (com.arpitjava.springbootbatch.step.Processor)itemProcessor;
					processorLoc.setJobName(job.getJobName());
					itemProcessor = processorLoc;
				}
